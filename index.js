...
//创造一个< div class="row">并且有四个字节点< div class="cell">
function createrow() {
    let con = $('con');
    let row = creatediv('row'); //创建div className=row
    let arr = creatcell(); //定义div cell的类名，其中一个为cell black
...
function creatcell() {
    ...
    let i = Math.floor(Math.random() * 4);//随机产生黑块的位置 Math.random()函数参数0~1的随机数
    temp[i] = 'cell black';
    return temp;
}
